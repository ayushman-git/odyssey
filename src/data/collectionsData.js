  ...
  books: [
    {
      ...
      rating: 4.5,
      description:
        "A proven framework for improving every day through tiny changes in behavior.",
    },
    {
      id: 2,
      title: "Sapiens",
    ...
    },
    {
      ...
      rating: 4.7,
      description:
        "A chilling portrayal of how a society dominated by a totalitarian government gives rise to a culture of fear and ignorance.",
    },
    {
      id: 8,
      ...
      rating: 4.5,
      description:
        "A story about the American dream, wealth, and unrequited love in the Jazz Age.",
    },
    {
      id: 9,
      title: "The Hobbit",
      ...
      genre: "Fantasy",
      rating: 4.8,
      description: "The tale of a hobbit who embarks on an unexpected journey.",
    },
    {
      id: 10,
      ...
      rating: 4.7,
      description:
        "A romantic novel about overcoming differences in social class.",
    },
    {
      id: 11,
      ...
      rating: 4.3,
      description: "A classic tale of teenage angst and alienation.",
    },
    {
      id: 12,
    ...
    },
    {
      ...
      rating: 4.9,
      description:
        "The first book in the Harry Potter series, introducing a young wizard and his adventures at Hogwarts School.",
    },
    {
      id: 14,
      ...
      rating: 4.6,
      description:
        "In a dystopian future, teenagers must fight to the death in an annual televised event.",
    },
    {
      id: 15,
    ...
    },
    {
      ...
      rating: 4.7,
      description:
        "A memoir about growing up in a survivalist family in Idaho and the struggle for education.",
    },
    {
      id: 19,
      ...
      rating: 4.8,
      description:
        "A novel about a girl who grows up isolated in the marshes of North Carolina and becomes a suspect in a murder.",
    },
  ],
  movies: [
    {
  ...
  experiences: [
    {
      ...
      coverImage:
        "https://images.unsplash.com/photo-1522163182402-834f871fd851?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      year: "2023",
    ...
    },
    {
      ...
      coverImage:
        "https://images.unsplash.com/photo-1565122256258-8827f448ddb6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      year: "2022",
      category: "experiences",
    },
  ],
