...
- **MCP Server**: Our program that actually provides the context and tools
 ...
 <figure
    ...
    <img src="https://github.com/ayushman-git/moonbox/blob/main/assets/images/mcp_arch.jpg?raw=true" alt="arecobo message grid" style={{
        borderRadius: "8px",
        margin: "24px auto"
    }} />
...
```
 ...
 <figure
    ...
    <img src="https://github.com/ayushman-git/moonbox/blob/main/assets/images/mcp_auth.png?raw=true" alt="arecobo message grid" style={{
        borderRadius: "8px",
        margin: "24px auto",
        width: "100vw"
    }} />
